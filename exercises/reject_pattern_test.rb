...
class RejectPatternTest < Minitest::Test
  ...
  def test_remove_dinosaurs
    ...
    animals.each do |animal|
      notasaurus << animal unless animal.include?('saur')
    end
  ...
  def test_remove_numbers
    ...
    elements.each do |elem|
      not_numbers << elem unless elem.class == Fixnum || elem.class == Float
    end
  ...
  def test_remove_arrays
    ...
    remaining = []
    elements.each do |elem|
      remaining << elem unless elem.class == Array
    end
  ...
  def test_remove_hashes
    ...
    remaining = []
    elements.each do |elem|
      remaining << elem unless elem.class == Hash
    end
