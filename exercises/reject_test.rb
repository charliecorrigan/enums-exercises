...
class RejectTest < Minitest::Test
  ...
  def test_remove_dinosaurs
    ...
    notasaurus = animals.reject do |ani|
      ani.include?('saur')
    end
  ...
  def test_remove_numbers
    ...
    not_numbers = elements.reject do |elem|
      elem.class == Float || elem.class == Fixnum
    end
  ...
  def test_remove_animals_starting_with_vowels
    ...
    remaining = animals.reject do |ani|
      ani[0].count('aeiouy') > 0
    end
  ...
  def test_remove_arrays
    ...
    remaining = elements.reject do |elem|
      elem.class == Array
    end
